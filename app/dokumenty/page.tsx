...
export const metadata: Metadata = { title: "Wzory dokumentów ubezpieczeniowych", description: "Wybierz aktualny wzór dokumentu OC i wypełnij go online.", alternates: { canonical: "/dokumenty" } };
